...
activity1 = Activity.create(title: 'Horse back riding', category: 'Active', location: '333 Main St Dallas, TX 76223', description: 'This is a place you can pay to ride a horse for 2 hours', image: 'https://tinyurl.com/bdzm6rpk', estPrice: 35, user: user2, relationship: relationship2)
activity2 = Activity.create(title: 'Skatig along the waterfront', category: 'Active', location: '333 Boarderline St Seattle, WA 76223', description: 'Skate along the waterfront', image: 'https://tinyurl.com/yc7u48pk', estPrice: 0, user: user3, relationship: relationship1)
activity3 = Activity.create(title: 'Dinner at Sushi', category: 'Dinner', location: '333 Main St New York, NY 12542', description: '5 course sushi dinner', image: 'https://tinyurl.com/4c5ubf2r', estPrice: 125, user: user1, relationship: relationship2)
